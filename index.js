...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    Counter 1 uses a closer and counter2 doesn't.
  2. Which of the two uses a closure? How can you tell?
   counter1 uses closure. Becuase its holding what is returned in a new variable. That can be accessed outside of the function.
...
function scoreboard(InningScoreCB,inningCB,numberInnings) {
  const scoreByInning = [];
  let homeScore = 0;
  let awayScore = 0;
  ...
  if(homeScore === awayScore){
    ...
    scoreByInning.push(`Fianal Score: Away: ${awayScore} - Home ${homeScore} `)
  }
